    ...
    <div style={{ background: C.bg, minHeight: '100vh', color: C.textPrimary, fontFamily: 'Space Mono, Courier New, monospace' }}>
      ...
      <section style={{ padding: 'clamp(56px,8vw,100px) clamp(16px,4vw,48px) clamp(40px,6vw,72px)', borderBottom: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 'clamp(13px,2vw,15px)', color: C.textSecondary, marginBottom: '40px', lineHeight: 1.75, maxWidth: '560px' }}>
      ...
      <section style={{ padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px)', borderBottom: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ fontSize: '11px', letterSpacing: '4px', color: C.cyan, marginBottom: '32px', opacity: 0.8 }}>
            SYSTEM CAPABILITIES
          </div>
          <div className="mc-grid-3">
            {FEATURES.map((f) => (
              <div key={f.id} style={{ background: C.surface, border: `1px solid ${C.border}`, padding: '24px' }}>
      ...
      <section style={{ padding: 'clamp(48px,6vw,80px) clamp(16px,4vw,48px)', borderBottom: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div className="mc-grid-4">
            {STACK.map((s) => (
              <div key={s.name} style={{ background: C.surface, border: `1px solid ${C.border}`, padding: '16px 20px' }}>
                <div style={{ fontFamily: 'var(--font-orbitron, Orbitron, sans-serif)', fontSize: '11px', letterSpacing: '2px', color: C.textPrimary, marginBottom: '6px', fontWeight: 700 }}>
                  {s.name}
                </div>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ padding: '28px clamp(16px,4vw,48px)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
