...
[![CI](https://github.com/your-username/mission-control-qa/actions/workflows/ci.yml/badge.svg)](https://github.com/your-username/mission-control-qa/actions/workflows/ci.yml)
[![Security Scan](https://github.com/your-username/mission-control-qa/actions/workflows/security-scan.yml/badge.svg)](https://github.com/your-username/mission-control-qa/actions/workflows/security-scan.yml)

---

## What this is

A fully simulated drone Ground Control Station built to demonstrate **quality engineering patterns for real-time, safety-critical systems**. The kind of system where a missed telemetry packet, a dropped command, or a UI freeze isn't just a bug — it's a mission failure.
...
[Deployment link — add after Vercel/Railway deploy]
